...
set FILSTR="file=@%ISSDRV%:\%ISSDIR:"=%\%PRDDIR:"=%\%FMWPRF%%SNXPRF%%PRDCOD%%PRDSUF%!SNXREV[%SNXDEX%]!_!SNXDAT[%SNXDEX%]!"
...
setlocal enabledelayedexpansion
set FILSTR="file=@%ISSDRV%:\%ISSDIR:"=%\%PRDDIR:"=%\%FMWPRF%%MOBPRF%%PRDCOD%%PRDSUF%!MOBREV[%MOBDEX%]!_!MOBDAT[%MOBDEX%}!"
