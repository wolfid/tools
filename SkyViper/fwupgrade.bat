...
set BINPTH="%SVNDIR:"=%\%ISSDIR:"=%\!PRDDIR[%SELENT%]:"=!\%FMWPRF%%SNXPRF%!PRDCOD[%SELENT%]!%SNXSUF%!SNXREV[%SNXDEX%]!_!SNXDAT[%SNXDEX%]!\%SNXBIN%.%SNXEXT%"
...
set SELENT=%SELENT:"=%
setlocal enabledelayedexpansion
set BINPTH="%SVNDIR:"=%\%ISSDIR:"=%\!PRDDIR[%SELENT%]:"=!\%FMWPRF%%CTLPRF%!PRDCOD[%SELENT%]!%CTLSUF%!CTLREV[%CTLDEX%]!_!CTLDAT[%CTLDEX%]!.%CTLEXT%"
endlocal & set BINPTH=%BINPTH%
:ISSDRV
