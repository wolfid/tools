...
set DEFDIR[SpiderDrone_WiFi]="SpiderDrone_WiFi"
set DEFDIR[Streaming]="Streaming"
set DEFCOD=01749
set DEFCOD[SpiderDrone_WiFi]=01749
set DEFCOD[Streaming]=01735
set DEFREV=595
...
set FLBEXT=hex
set UPGMOD=0
set UPGIMG=%ISSDRV%:\%ISSDIR:"=%\%DEFDIR%\%FMWPRF%%SNXPRF%%DEFCOD%%SNXSUF%%DEFREV%_%DEFDAT%\%SNXBIN%.%SNXEXT%
set UPGIMG=
