...
set VERPTH[DB]="%PRJDRV%:\%SUBDIR%\%DEVBRA%\%SDKDIR%\%IMGAPP%\%IMGTYP%\%IMGSRC%"
set VERPTH[PD]="%PRJDRV%:\%SUBDIR%\%DEVBRA%\%SDKDIR%\%IMGAPP%\%IMGTYP%\%IMGSRC%"
set VERPTH[RC]="%PRJDRV%:\%SUBDIR%\%DEVBRA%\%SDKDIR%\%IMGAPP%\%IMGTYP%\%IMGSRC%"
set VERPTH[FL]="%PRJDRV%:\%SUBDIR%\%DEVBRA%\%SDKDIR%\%IMGAPP%\%IMGTYP%\%IMGSRC%"
